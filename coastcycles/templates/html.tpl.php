...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <?php if ($default_mobile_metatags): ?>
    ...
    <meta property="og:image" content="http://www.johnnycoast.com/sites/all/themes/coastcycles/images/og-pic.png"/>
  <?php endif; ?>
  ...
  <?php endif; ?>
  <!--[if lt IE 9]>
    <script src="<?php global $base_url; print $base_url;?>/sites/all/themes/coastcycles/js/selectivizr.js"></script>
  <![endif]-->
